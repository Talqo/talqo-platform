...
The widget is served directly from the PagePal domain:

```html
<script async defer src="https://pagepal.dyn.cloud.e-infra.cz/widget-bundle.js"></script>
```
...
2. Check that the PagePal domain is accessible
