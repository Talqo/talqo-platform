			...
			<div className="container relative mx-auto max-w-7xl">
				...
				<div className="mt-16 rounded-4xl border border-border bg-primary p-6 text-center text-primary-foreground shadow-2xl shadow-primary/20 sm:p-8">
					...
					<div className="mt-6 flex flex-col justify-center gap-3 sm:flex-row">
						...
						<Button
							variant="outline"
							className="rounded-md border-primary-foreground/40 bg-transparent px-6 font-bold text-primary-foreground hover:bg-primary-foreground/10 hover:text-primary-foreground"
							asChild
						>
							<a
